...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('patient.store') }}" class="row g-3">
                @csrf
                <div class="col-md-6 mb-2">
                    <label for="id_card" class="form-label">{{ __('Id Card') }}</label>
                    <input type="text" name="id_card" class="form-control" id="id_card" autofocus>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="family_relationship" name="family_relationship">
                </div>
